...
import {TransactionsCollectionService, TransactionViewModel} from '../../shared';
...
export class TransactionsService {
  ...
  constructor(private readonly _statusesCollectionService: TransactionsCollectionService,
              private readonly _snackbarService: MatSnackBar) {
    this.transactions$ = _statusesCollectionService.getTransactionsByIncomingStatusKey();
  }
